...
Exercise 31_22 - table view include delete row button
 */
...
public class Exercise31_22 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Button btDelRow = new Button("Delete selected row");
        ...
        primaryStage.setTitle("Exercise 31_22"); // Set the window title
